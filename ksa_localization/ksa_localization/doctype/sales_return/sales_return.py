...
from ksa_localization.utils.serial_no import get_delivery_note_serial_no
...
class SalesReturn(SellingController):
	...
	if TYPE_CHECKING:
		...
		from ksa_localization.ksa_localization.doctype.sales_return_item.sales_return_item import SalesReturnItem
		...
		is_pos: DF.Check
		is_return: DF.Check
		items: DF.Table[SalesReturnItem]
		...
		naming_series: DF.Literal["SINV-RET-.YYYY.-"]
	...
	def validate_for_repost(self):
		...
		self.validate_account_for_change_amount()
		self.validate_income_account()
		validate_docs_for_voucher_types(["Sales Return"])
	...
	def validate_fixed_asset(self):
		for d in self.get("items"):
			if d.is_fixed_asset and d.meta.get_field("asset") and d.asset:
				...
				if self.doctype == "Sales Return" and self.docstatus == 1:
	...
	def check_if_consolidated_invoice(self):
		...
		if self.doctype == "Sales Return" and self.is_consolidated:
